...
import com.cellstudio.cellstream.databinding.ItemHomeBinding
...
class HomeAdapter(private var models: List<VideoResponse>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class ItemViewHolder(binding: ItemHomeBinding, private val listener: Listener?) : RecyclerView.ViewHolder(binding.root) {
